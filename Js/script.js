...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi querida Anyelin:\n\n"Desde que te conocí, mi vida cambió de una manera especial. Agradezco a Dios por tu vida, por la luz que trajiste a la mía, y nunca voy a olvidar aquel mensaje en Navidad que marcó el inicio de nuestra historia. Eres tan bonita como un atardecer, tan hermosa y alegre como un girasol, y tú eres mi sueño ideal, la persona por la que tanto oré en mi vida. ".`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con mucho cariño, Jafet";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-12-25T00:00:00'); 
  ...
  function update() {
    ...
    container.innerHTML =
      `Todo cambió hace 🌻❤️: <b>${days}</b> días<br>` +
      `Tu cumpleaños: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
